...
Blockly.Blocks['text'] = {
    ...
    newQuote_ : function(open) {
        ...
        return new Blockly.FieldImage(Blockly.pathToBlockly + 'media/' + file, 12, 12, '"');
    }
};
...
Blockly.Blocks['text_join'] = {
    ...
    init : function() {
        ...
        this.setColourRGB(Blockly.CAT_TEXT_OPS_RGB);
    ...
    domToMutation : function(xmlElement) {
        ...
        if (this.itemCount_ == 0) {
            this.appendDummyInput('EMPTY').appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'media/quote0.png', 12, 12, '"')).appendField(
                    new Blockly.FieldImage(Blockly.pathToBlockly + 'media/quote1.png', 12, 12, '"'));
        }
    },
    /**
...
Blockly.Blocks['text_prompt'] = {
    ...
    init : function() {
        ...
        this.appendDummyInput().appendField(dropdown, 'TYPE').appendField(this.newQuote_(true)).appendField(new Blockly.FieldTextInput(''), 'TEXT')
