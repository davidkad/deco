...
Blockly.makeColour = function(hue) {
    return goog.color.hsvToHex(hue, Blockly.HSV_SATURATION, Blockly.HSV_VALUE * 256);
};

/**
 * The rgb value for the categories in the toolbox and the blocks
 */
Blockly.CAT_EVENTS_RGB = [ 255,170,0 ]; //#FFAA00
Blockly.CAT_SPRITES_RGB = [ 251,192,45 ]; //#FBC02D
Blockly.CAT_ANIM_RGB = [ 161,136,127 ]; //#A1887F
Blockly.CAT_MOTION_RGB = [ 149,117,205 ]; //#9575CD
Blockly.CAT_LOGIC_RGB = [ 79,195,247 ]; //#4FC3F7
Blockly.CAT_LOGIC_OPS_RGB = [ 77,182,172 ]; //#4DB6AC
Blockly.CAT_LOOPS_RGB = [ 77,208,225 ]; //#4DD0E1
Blockly.CAT_MATH_RGB = [ 121,134,203 ]; //#7986CB
Blockly.CAT_MATH_OPS_RGB = [ 158,158,158 ];  //#9E9E9E
Blockly.CAT_TEXT_RGB = [ 139,195,74 ]; //#8BC34A
Blockly.CAT_TEXT_OPS_RGB = [ 158,158,158 ];  //#9E9E9E
Blockly.CAT_TEXT_LITERAL_RGB = [ 66,189,65 ]; //#42BD41
Blockly.CAT_VARIABLES_RGB = [ 144,164,174 ]; //#90A4AE
...
Blockly.onKeyDown_ = function(e) {
    ...
    if (e.keyCode == 27) {
        ...
        if (Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && Blockly.selected.workspace == Blockly.mainWorkspace) {
            Blockly.hideChaff();
            if (e.keyCode == 67) {
                // 'c' for copy.
